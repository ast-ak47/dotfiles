...
}:
{
  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      windowrule = [
        "match:title psycho_lock, stay_focused on"
        "match:title psycho_lock, no_close_for 86400000"
      ];
      ...
      bind = [
        ...
        # Psycho Lock command
        "$mainMod, L, exec, ~/GitHub/psycho_lock/build/linux/x64/release/bundle/psycho_lock"
      ];
  ...
  programs.waybar = {
    ...
    style = ''
              @define-color bg #8560fe;
              @define-color char #080719;
  ...
  programs.rofi = {
    ...
    theme =
      ...
      {
        "*" = {
          background-color = mkLiteral "#2f2258";
          border-color = mkLiteral "#2f2258";
          text-color = mkLiteral "#080719";
          spacing = 0;
          width = 512;
        };
        "#inputbar" = {
        ...
        "#element selected" = {
          background-color = mkLiteral "#8560fe";
        };
        "#element-text" = {
  ...
  xdg.configFile."libskk/rules".source = ./config/skk/skk_rules;
